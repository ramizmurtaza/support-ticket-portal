<?php $__env->startSection('title', 'Edit System'); ?>
<?php $__env->startSection('page-title', 'Edit System: ' . $system->name); ?>

<?php $__env->startSection('content'); ?>

<div class="max-w-xl">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="<?php echo e(route('admin.systems.update', $system->id)); ?>">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PATCH'); ?>

            <div class="mb-5">
                <label for="name" class="block text-sm font-medium text-gray-700 mb-1">System Name</label>
                <input type="text" id="name" name="name" value="<?php echo e(old('name', $system->name)); ?>" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-5">
                ...
                <input type="text" value="<?php echo e($system->system_id); ?>" disabled
                ...
                <label class="flex items-center gap-3 cursor-pointer">
                    <div class="relative">
                        <input type="checkbox" name="is_active" value="1"
                               <?php echo e(old('is_active', $system->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ramizmurtaza/development/support/support-ticket-portal/resources/views/admin/systems/edit.blade.php ENDPATH**/ ?>