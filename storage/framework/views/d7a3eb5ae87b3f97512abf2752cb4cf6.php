...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Support Portal'); ?> — Admin</title>
    ...
    <aside class="w-64 bg-gray-900 text-white flex flex-col flex-shrink-0">
        ...
        <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
            <a href="<?php echo e(route('admin.dashboard')); ?>"
               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'); ?>">
            ...
            <a href="<?php echo e(route('admin.tickets.index')); ?>"
               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors <?php echo e(request()->routeIs('admin.tickets.*') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.tickets.index', ['status' => 'open'])); ?>"
            ...
            <a href="<?php echo e(route('admin.tickets.index', ['status' => 'resolved'])); ?>"
               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-gray-300 hover:bg-gray-800 hover:text-white transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.systems.index')); ?>"
               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors <?php echo e(request()->routeIs('admin.systems.*') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php if(session('api_key')): ?>
            <div id="flash-apikey" class="mx-6 mt-4 px-4 py-3 bg-amber-50 border border-amber-300 text-amber-900 rounded-lg text-sm">
                ...
                <div class="flex items-center gap-3 mt-2">
                    <code id="api-key-value" class="font-mono bg-amber-100 px-3 py-1.5 rounded text-sm flex-1 break-all"><?php echo e(session('api_key')); ?></code>
...
<?php /**PATH /Users/ramizmurtaza/development/support/support-ticket-portal/resources/views/admin/layouts/admin.blade.php ENDPATH**/ ?>